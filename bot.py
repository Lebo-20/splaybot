...
class DownloaderBot:
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """Handle /help command"""
        help_text = (
            "🚀 <b>SplayBot — Pusat Bantuan & Panduan</b>\n\n"
            "Bot ini dirancang untuk mendownload dan memproses video drama pendek (short-form) dengan fitur otomasi subtitle.\n\n"
            "📂 <b>CARA PENGGUNAAN (MAIN FLOW)</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "1️⃣ <b>Via File JSON</b>\n"
            "   Kirimkan file <code>.json</code> (Dramabox, Dramawave, dll) langsung ke chat ini.\n"
            "2️⃣ <b>Via Link JSON</b>\n"
            "   Kirimkan URL API (dramabox/rishort) langsung di chat.\n\n"
            "📥 <b>PERINTAH MANUAL (DOWNLOAD LINK)</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "✨ <b>Download 1 Episode:</b>\n"
            "   <code>/l [Judul] [Link_M3U8]</code>\n"
            "   <i>Contoh: /l Ep01 https://rishort.com/...</i>\n\n"
            "📦 <b>Batch Download (Banyak Link):</b>\n"
            "   <code>/batch [Judul] [Link1] [Link2] ...</code>\n"
            "   <i>Maksimal 200 link per satu kali instruksi.</i>\n\n"
            "💬 <b>PENGATURAN SUBTITLE</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "Jika subtitle terdeteksi, bot akan memberikan 4 pilihan:\n"
            "🔹 <b>Softsub</b>: Subtitle tertanam dalam video (bisa On/Off).\n"
            "🔹 <b>Hardsub</b>: Subtitle dibakar permanen ke dalam video.\n"
            "🔹 <b>Separate</b>: File .srt dikirim secara terpisah.\n"
            "🔹 <b>None</b>: Kirim video mentah tanpa subtitle.\n\n"
            "⚙️ <b>KEKUASAAN ADMIN & SISTEM</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "🔄 <code>/update</code> - Sinkronisasi kode dengan GitHub.\n"
            "❌ <code>/cancel</code> - Batalkan semua proses aktif & hapus file.\n"
            "⚙️ <code>/start</code> - Ganti Default Kualitas & Format (MP4/MKV).\n\n"
            "📝 <i>Semua file diproses otomatis < 50MB agar mudah diakses di Telegram.</i>"
        )
        await update.message.reply_text(
            help_text,
            parse_mode="HTML",
