...
class DownloaderBot:
    ...
    async def help(self, update: Update, context: ContextTypes.DEFAULT_TYPE):
        """Handle /help command"""
        help_text = (
            "🎭 <b>SplayBot — Ultimate Drama Downloader</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "<i>Solusi download drama pendek (Short-Drama) dengan otomasi subtitle cerdas.</i>\n\n"
            "📥 <b>METODE DOWNLOAD</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "🔹 <b>Metode 1: Otomatis (Rekomendasi)</b>\n"
            "Cukup kirimkan file <code>.json</code> atau <b>Link API</b> (Dramabox, Dramawave, dll) langsung ke chat ini.\n\n"
            "🔹 <b>Metode 2: Manual (Single)</b>\n"
            "<code>/l [Judul] [Link_M3U8]</code>\n"
            "• Contoh: <code>/l Ep01 https://.../playlist.m3u8</code>\n"
            "• Jika judul dikosongkan, bot akan membuat judul otomatis.\n\n"
            "🔹 <b>Metode 3: Batch (Banyak Link)</b>\n"
            "<code>/batch [Judul] [Link1] [Link2] ...</code>\n"
            "• Mendukung hingga 200 link sekaligus.\n"
            "• Penomoran episode (Ep01, Ep02...) dibuat otomatis.\n\n"
            "💬 <b>SISTEM SUBTITLE</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "Jika subtitle ditemukan, Anda akan diberikan 4 opsi:\n"
            "📽 <b>Softsub</b> : Subtitle tertanam (bisa switch On/Off).\n"
            "🔥 <b>Hardsub</b> : Subtitle dibakar permanen ke video.\n"
            "📄 <b>Separate</b>: Video & Subtitle dikirim sebagai 2 file.\n"
            "🚫 <b>None</b>     : Video mentah tanpa subtitle.\n\n"
            "🛠 <b>FITUR UNGGULAN</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "✅ <b>Smart Compression</b>: Otomatis < 50MB (Hemat Kuota).\n"
            "✅ <b>HLS Optimized</b>: Download super cepat dengan multi-thread.\n"
            "✅ <b>Group Topic Support</b>: Mendukung pengiriman di topik forum.\n"
            "✅ <b>Auto Cleanup</b>: File sampah langsung dihapus setelah kirim.\n\n"
            "🚩 <b>PERINTAH LAIN</b>\n"
            "━━━━━━━━━━━━━━━━━━━━━━━━\n"
            "• <code>/update</code> : Sinkronisasi fitur terbaru (Admin).\n"
            "• <code>/cancel</code> : Batalkan semua proses & hapus session.\n"
            "• <code>/start</code>  : Ganti format (MP4/MKV) & kualitas.\n\n"
            "<i>Didukung: Dramabox, GoodShort, Rishort, FlikReels, Stardust, Vigloo, Velolo, & HLS Proxy.</i>"
        )
        await update.message.reply_text(
            help_text,
            parse_mode="HTML",
...
def main():
    ...
    print("Fitur:")
    print("Fitur:")
    print("v Auto detect semua episode (termasuk dramabox v2)")
    print("v Auto detect subtitle Indonesia (id, ind, bahasa, dll)")
    print("v Hard subtitle otomatis (JSON flow)")
    print("v Deteksi subtitle HLS + pilihan embed/none/separate (/l & /batch)")
    print("v Batch download via JSON")
    print("v Auto cleanup files setelah selesai")
    print("v Auto hapus session jika error")
    print("v /l [judul] [link]  - Download single video dengan judul kustom")
    print("v /batch [judul] [link1] [link2] ... - Batch download multi-episode")
    print("v Mendukung Rishort, GoodShort, HLS Proxy")
    print("v Kompresi otomatis < 50MB untuk Telegram")
    print("v Merge video + audio terpisah otomatis")
    print("v Parallel segment download untuk HLS")
    print("v Auto refresh token HLS jika expired")
    print("-" * 60)
